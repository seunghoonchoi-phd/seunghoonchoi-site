...
في فحص الملفات الحقيقي لا تنقسم كل الأحكام بوضوح. تداخل مربعات النص، أو فيضان الحروف، أو الخط الصغير، أو تغير نسبة الصورة قد يكون عيباً، لكنه قد يكون أيضاً إخراجاً مقصوداً. لذلك يجب أن تُقسم نتيجة الفحص. العيوب البنيوية الواضحة تُعلَّم كـ `ERROR`. والأشياء التي تحتاج إلى عين بشرية تُترك كـ `WARN`.
