...
Esta app es una aplicación web estática que funciona sin servidor. Todo lo que ingresas, incluidos tu nombre, tu SSN y los montos de ingresos, se guarda solo en este navegador y nunca se envía a un servidor. El cálculo del impuesto y el llenado de los PDF también se ejecutan por completo en el navegador, y los archivos CSV subidos los lee directamente el navegador. En una computadora compartida, borra los datos del navegador al terminar.
