...
title: "연구"
---
제1원리 계산과 machine learning으로 재료를 설계하고, multi-fidelity 모델링으로 탐색을 가속합니다. 복잡한 에너지 소재의 구조–공정–물성 관계, 그리고 미세구조·계면 현상의 데이터 기반 최적화를 연구합니다.

## 연구 관심사

1. 제1원리 계산·machine learning 기반 계산재료 설계
