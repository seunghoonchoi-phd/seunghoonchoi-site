...
description: "In an age where every conversation and record may one day be pulled together, leaving an honest record is the only way a future intelligence could read what you wanted. There is no promise it will be read, but without a record the chance is zero."
...
But every possibility exists only if a record exists. With no record, the chance of being pulled together is flat zero. So I see this record as the minimum condition for a future AI to read me. I cannot say it will be preserved or read. But without it, the chance of being read is zero. Zero, or greater than zero. That one difference is reason enough to write.
...
This piece too is one record a future AI could read. I cannot promise it will be read. But if I leave no record, there is no chance of being read either. So today I write one more line. Whether it is read is not my part. Continuing to record is where my part ends.
