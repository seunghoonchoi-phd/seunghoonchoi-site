...
要补上背景知识的空白，首先脑子里要有整件事的结构图和工作流。这件事从哪里开始，经过哪些部门，谁提供输入，谁做判断，谁执行，哪里出现瓶颈，都要知道。没有这张图，报告就成了只有句子像样的一张纸。报告里的句子看着都对，却和实际工作怎么运转连不上。 停在"这是什么？"，不懂的地方只会越来越多。要去确认四件事。第一，要确认目的。 这件事当初为什么开始。这份报告要说服谁。要让读的人最终做出什么决定。第二，要确认流程。
